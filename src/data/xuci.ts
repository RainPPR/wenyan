...
export const XUCI: VocabularyEntry[] = [
  {
    ...
    "examTips": "“而”字高考常考转折（却）、修饰（连接状语）与递进（并且）。注意代词用法“而翁”（你的父亲）及固定短语“而已”（罢了）。"
  },
  {
    "id": "xuci_he",
    "word": "何",
  ...
  },
  {
    ...
    "examTips": "“乃”表转折（竟然）与判断（是）是高考考查重点。代词“乃翁”（你的父亲）、“乃父”（你的父亲）需熟记。"
  },
  {
    "id": "xuci_qi",
    "word": "其",
        ...
        "examples": [
          {
            ...
            "source": "《送东阳马生序》",
            "translation": "如果他们的学业有不精通的，德行有不成的，不是天资低下，而是心思不如我专一罢了。"
          }
        ]
      },
      {
        ...
        "examples": [
          {
            ...
            "source": "《阿房宫赋》",
            "translation": "唉！灭亡六国的是六国自己啊，不是秦国。灭亡秦国的是秦国自己啊，不是天下人。"
          }
        ]
      },
      {
        ...
        "examples": [
          {
            ...
            "source": "《阿房宫赋》",
            "translation": "假使秦国能爱护六国的百姓，那就可以顺传三代直到万代做君王，谁能够族灭他们呢？"
          }
        ]
      },
      {
        ...
        "examples": [
          {
            ...
            "source": "《生于忧患，死于安乐》",
            "translation": "在内部如果没有守法度的世臣和辅佐的贤士，在外部如果没有敌对的国家和外患，国家往往会灭亡。"
          }
        ]
      },
      {
        ...
        "examples": [
          {
            "text": "君子疾夫舍曰欲之而必为之辞。",
            "source": "《季氏将伐颛臾》",
            "translation": "君子厌恶那种避而不言自己想要却一定要为它找借口的行为。（前一个“之”：这样；后一个“之”：它）"
          }
        ]
      },
      {
    ...
    "senses": [
      {
        ...
        "examples": [
          ...
          },
          {
            ...
            "source": "《报任安书》",
            "translation": "左丘明双目失明，才撰写出了《国语》；孙膑被砍去了膝盖骨，才编著出了《兵法》。"
          }
        ]
      }
    ],
